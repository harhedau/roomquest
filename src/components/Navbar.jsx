...
function Navbar() {
  return (
<>
  <nav className=" bg-stone-300 flex justify-between px-3 rounded-md">
    <div>
    ...
    <button className="hidden md:block bg-zinc-800 text-white rounded-md p-2 w-full mx-2 font-bold">Login</button>
    <button className="hidden md:block bg-zinc-800 text-white rounded-md p-2 w-full font-bold">Registration</button>
    </div>
  </nav>
  <div>
